...
public class DebtInstallment : SoftDeleteEntity
{
    ...
    public bool HasPartialPayment=> AmountPaid.HasValue && AmountPaid.Value > 0 && !IsPaid;
    ...
    public DomainResult Pay(decimal amountPaid, DateTime paymentDate)
    {
