...
namespace Zenvus.Infra.Database.Migrations
{
    ...
    [Migration("20251220150934_Transactions_ExpenseAlterColumnName")]
    partial class Transactions_ExpenseAlterColumnName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Zenvus.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 12, 20, 15, 9, 32, 663, DateTimeKind.Utc).AddTicks(326));
