...
namespace Zenvus.Infra.Database.Migrations
{
    ...
    [Migration("20260113033354_Expense_AddNewColumn")]
    partial class Expense_AddNewColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Zenvus.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2026, 1, 13, 3, 33, 53, 59, DateTimeKind.Utc).AddTicks(5468));
