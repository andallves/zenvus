...
import { DeleteIncomeTemplateComponent } from './delete-income-template.component';
...
describe('DeleteIncomeTemplateComponent', () => {
  let component: DeleteIncomeTemplateComponent;
  let fixture: ComponentFixture<DeleteIncomeTemplateComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [DeleteIncomeTemplateComponent, ButtonComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(DeleteIncomeTemplateComponent);
