...
import { UpdateIncomeFormComponent } from './update-income-form.component';

describe('PayDebtInstallmentFormComponent', () => {
  let component: UpdateIncomeFormComponent;
  let fixture: ComponentFixture<UpdateIncomeFormComponent>;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, FormsModule, UpdateIncomeFormComponent],
      providers: [
        ValidationService,
    ...
    fixture = TestBed.createComponent(UpdateIncomeFormComponent);
