...
export class HeaderTableComponent {
  @Input() title = '';
  @Input() mobileTitle = '';
  @Input() mobileTitleIcon = this.svgImg;
  @Input() buttonTitle = '';
